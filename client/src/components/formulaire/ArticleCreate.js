                        ...
                        <div className="col-lg-6 pt-5 pt-lg-0">
                            <form className="single-product-content" onSubmit={handleSubmit}>
                                <div className="price-box">
                                    ...
                                    <div>
                                        <input className="cart-plus-minus-box" placeholder="Ex: American Marigold" type="text" required onChange={e => setName(e.target.value)}/>
                                    </div>
                                    <div className="price-box">
                                        <span className="new-price">Prix</span>
                                        <div>
                                            <input className="cart-plus-minus-box" type="number" step="0.01" required onInput={e => setPrice(e.target.value)}/>
                                        </div>
                                    </div>
                                    <div className="price-box">
                                        <span className="new-price">Description</span>
                                        <div className="input-group">
                                            <textarea className="form-control" aria-label="With textarea" placeholder="A normal description" required onChange={e => setDescription(e.target.value)}></textarea>
                                        </div>
                                    </div>
                                    <div className="price-box">
                                        <span className="new-price">Caractéristique</span>
                                        <div className="input-group">
                                            <input type="text" className="form-control" placeholder="Ex: Écran 4K" required onChange={e => setFeature(e.target.value)}/>
                                        </div>
                                    </div>
                                    <div className="price-box">
...
export default FormArticleCreate;